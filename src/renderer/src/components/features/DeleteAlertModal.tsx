    ...
    >
      ...
      >
        <div className="h-12 border-b border-border flex items-center justify-between px-5 bg-bg-panel shrink-0">
           <span className="text-[13px] font-bold tracking-wider">删除告警记录</span>
        ...
        <div className="p-6 space-y-4">
           <div className="flex items-start space-x-4">
              ...
              <div className="pt-1">
                 <h3 className="text-[13px] font-bold text-text-primary">确定要永久删除该告警吗？</h3>
                 <p className="text-[11px] text-text-secondary mt-2 leading-relaxed">
                   删除后将无法查看该条告警的黑匣子快照数据与 AI 诊断报告，且该操作不可逆转。
                 </p>
              </div>
           </div>
        </div>
        ...
        <div className="h-14 border-t border-border bg-bg-active/30 flex items-center justify-end px-5 space-x-3 shrink-0">
           ...
           <button onClick={onConfirm} className="bg-red-500/90 hover:bg-red-500 text-white px-5 py-1.5 text-[12px] font-bold rounded-lg transition-colors shadow-[0_0_15px_rgba(239,68,68,0.2)]">确认删除</button>
        </div>
      </div>
    </div>
  );
